...
else return conn.reply(m.chat, `*Y LA IMAGEN? 🤔 RESPONDE A UNA IMAGEN, VIDEO, GIF PARA REALIZAR EL STICKERS USE* *${usedPrefix + command}*`, m, {contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: iig, body: '𝙋𝙍𝙊𝙔𝙀𝘾𝙏𝙊 - 𝙈𝘿 🕷️', previewType: 0, thumbnail: img.getRandom(), sourceUrl: redes.getRandom()}}})
}}
